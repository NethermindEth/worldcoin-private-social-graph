...
describe("Poseidon tests", () => {
    ...
    it("Noir: Should return the correct hash", async () => {
        ...
        expect(BigInt(hash)).toBe(BigInt("2056449770998421094693270621231289260402432781619773239530425938274273592166"))

        hash = await hash4([x,x,x,x])
        expect(BigInt(hash)).toBe(BigInt("12501290995084169344073844953692250674022814101925614641583223360631835071976"))
    })
