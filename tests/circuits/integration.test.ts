    ...
    it('Should verify a valid vote transaction', async function () {
        ...
        expect(
            await vote_pour(
                ...
                h_sig.toString(),
                h.toString(),
                siblings.map((i) => i.toString()),
                pathIndices.map((i) => i.toString()),
                old_coin_pk_address.toString(),
                old_coin_value.toString(),
                old_coin_nullifier_seed.toString(),
                old_coin_r.toString(),
                old_coin_commitment.toString(),
                old_sk.toString(),
                new_coin_1_pk_address.toString(),
                new_coin_1_value.toString(),
                new_coin_1_nullifier_seed.toString(),
                new_coin_1_r.toString(),
                new_coin_1_commitment.toString(),
                new_coin_2_pk_address.toString(),
                new_coin_2_value.toString(),
                new_coin_2_nullifier_seed.toString(),
                new_coin_2_r.toString(),
                new_coin_2_commitment.toString()
            )
        ).toBe(true);
    });
